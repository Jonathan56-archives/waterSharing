...
#################### OLD MERGE  Data with Census Data (Does not include rationing)

      #Writing a file to clean before we can do the merge
...
#################### New MERGE  Data with Census Data: Includes rationing and drought data
